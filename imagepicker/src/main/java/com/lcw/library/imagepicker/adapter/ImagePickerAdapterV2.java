 ...
 */
public class ImagePickerAdapterV2 extends RecyclerView.Adapter<ImagePickerAdapterV2.BaseHolder> {
...
//    private boolean isShowCamera;
    ...
    public ImagePickerAdapterV2(Context context, List<MediaFile> mediaFiles) {

 ...
 */
public class ImagePreActivityV2 extends BaseActivity {
    ...
    protected void initListener() {
        ...
        mLlPreSelect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (curIsSelected) {
                    ...
                    updateCommitButton();
                } else if (SelectionManagerV2.getInstance().canSelected(mActivity, mediaFile)) {
        ...
        mIvPlay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Uri uri = FileProvider.getUriForFile(ImagePreActivityV2.this, ImagePickerProvider.getFileProviderName(ImagePreActivityV2.this), new File(mMediaFileList.get(mViewPager.getCurrentItem()).getPath()));
    ...
    private void updateCommitButton() {
        ...
        int maxCount = ConfigManagerV2.getInstance().getMaxCount();
    ...
    private void updateSelectButton(MediaFile mediaFile) {
        boolean isSelect = SelectionManagerV2.getInstance().isImageSelect(mediaFile);
        if (isSelect) {
